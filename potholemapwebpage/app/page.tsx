  ...
  return (
    <div className={`flex flex-col h-screen bg-gray-100 dark:bg-gray-900`}>
      ...
      <main className="flex-grow relative p-4 flex">
        ...
        <div className="relative w-[100%] h-full rounded-3xl overflow-hidden border border-gray-300 dark:border-gray-600 shadow-lg">
          {/* Dynamically loaded map */}
          {typeof window !== "undefined" && <MinimalMap />}
        </div>
        {/* Buttons container */}
